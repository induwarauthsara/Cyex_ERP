                ...
                success: function(response) {
                        ...
                        <div class="register-summary">
                            ...
                            ${isOpen ? `
                                ...
                                <p><strong>Cash Out/Petty Cash:</strong> Rs. ${parseFloat(registerDetails.cash_out || 0).toFixed(2)}</p>
                                <p><strong>Expected Cash in Drawer:</strong> Rs. ${parseFloat(registerDetails.expected_cash || 0).toFixed(2)}</p>
                    ...
                    let buttonsHtml = `
                        <div style="margin: 20px 0;">
                            ...
                            ${isOpen ? `<button id="cashOut" class="swal2-styled" onclick="cashOutModal()">Cash Out / Petty Cash</button>` : ''}
                        ...
                        html: `
                            <div style="text-align: left; margin: 20px 0;">
                                <div class="register-summary">
                                    ...
                                    <p><strong>Cash Outs:</strong> ${parseFloat(summary.cash_out).toFixed(2)}</p>
                                ...
                                .then(accountsData => {
                                    ...
                                    Swal.fire({
                                        ...
                                        html: `
                                            <div style="text-align: left; margin: 20px 0;">
                                                <div class="form-group">
                                                    <label for="petty_cash_for">Cash Out For:</label>
                                                    <input type="text" id="petty_cash_for" class="swal2-input" placeholder="Purpose of cash out">
                                                </div>
                                                <div class="form-group">
                                        ...
                                        preConfirm: () => {
                                            ...
                                            if (!purpose) {
                                                Swal.showValidationMessage('Please enter purpose of cash out');
                                                return false;
                                            }
                                        ...
                                        if (result.isConfirmed) {
                                            showLoadingAnimation('Processing cash out...');
                                            ...
                                            .then(response => {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(regResponse) {
                                                        try {
                                                            ...
                                                            if (regData.success) {
                                                                ...
                                                                Swal.fire({
                                                                    title: 'Warning!',
                                                                    text: 'Cash out recorded in accounts but not in register: ' + regData.message,
                                                                    icon: 'warning'
                                                                });
                                                            }
                                                        } catch(e) {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                text: 'Cash out recorded in accounts but there was an issue with the register system',
                                                                icon: 'warning'
                                                            });
                                                        }
                                                    },
                                                    error: function(xhr, status, error) {
                                                        ...
                                                        Swal.fire({
                                                            title: 'Success with Warning!',
                                                            text: 'Cash out recorded in accounts but register update failed',
                                                            icon: 'warning'
                                                        });
                                                    }
                                                });
