...
$sql = "UPDATE `employees` SET `emp_name` = '$emp_name', `mobile` = '$mobile', `address` = '$address', `bank_account` = '$bank_account', `role` = '$role', `nic` = '$nic', `salary` = '$salary', `day_salary` = '$day_salary' WHERE `employees`.`employ_id` = {$employ_id}";
