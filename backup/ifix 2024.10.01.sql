...
--
-- Host: localhost
-- Generation Time: Sep 30, 2024 at 09:02 PM
...
(59, 'Xpc25 micro normal charger', NULL, 79, 850.00, 400.00, 450.00, '1', 5, 0.00, NULL, '0'),
...
--
ALTER TABLE `action_log`
  MODIFY `action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=649;
...
--
ALTER TABLE `products`
  MODIFY `product_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
--
ALTER TABLE `transaction_log`
  MODIFY `transaction_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
