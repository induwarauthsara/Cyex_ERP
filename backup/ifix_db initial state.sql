...
--
-- Host: localhost
-- Generation Time: Sep 08, 2024 at 10:42 PM
...
(1, 'Stock Account', 'cash', -135.00),
(2, 'Company Profit', 'cash', 1235.25),
(6, 'Utility Bills', 'cash', 83420.30),
(7, 'cash_in_hand', 'cash', 136774.70),
(12, 'BOC', 'bank', 6800.00);
...
(0, 'ifix', 718366077, '', '', 'Admin', '', 127.75, 0.00, 'indroot', 1, '', 0, '2024-09-08'),
(1, 'lakmal', 718366077, '0', '0', 'Admin', '0', 600.00, 0.00, 'admin@132', 1, '', 1, '2024-09-08');
