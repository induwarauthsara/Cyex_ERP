...
--
-- දායකයා: localhost
-- උත්පාදන වේලාව: ඔක්තෝම්බර් 21, 2024 දින 06:30 PM ට
-- සේවාදායකයේ අනුවාදය: 10.6.18-MariaDB-0ubuntu0.22.04.1
-- PHP අනුවාදය: 8.1.2-1ubuntu2.18
...
--
-- වගු සඳහා නික්ෂේප දත්ත `accounts`
--

INSERT INTO `accounts` (`id`, `account_name`, `account_type`, `amount`) VALUES
(1, 'Stock Account', 'cash', -21155.00),
(2, 'Company Profit', 'cash', 34475.00),
(6, 'Utility Bills', 'cash', 0.00),
(7, 'cash_in_hand', 'cash', 21450.00),
...
--
-- වගු සඳහා නික්ෂේප දත්ත `action_log`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `bank_deposits`
--
...
(0, 'ifix', 718366077, '', '', 'Admin', '', 6800.00, 0.00, 'indroot', 1, '', 0, '2024-09-08'),
(1, 'lakmal', 718366077, '0', '0', 'Admin', '0', -52163.50, 0.00, 'admin@132', 1, '', 1, '2024-09-08'),
(14, 'Udaya', 779006160, '0', '8130907192 Commercial', 'Employee', '861722787', 2400.00, 0.00, 'udaya', 1, NULL, 1, '2024-09-10'),
(15, 'Kasun', 0, '0', '0', 'Employee', '0', 1100.00, 0.00, 'kasun', 1, NULL, 1, '2024-09-10');
...
--
-- වගු සඳහා නික්ෂේප දත්ත `InvoiceBalPayRecords`
--
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `makeProduct`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `makeProduct`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `oneTimeProducts_sales`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `pettycash`
--
...
(494, 'MTB Tempered', NULL, 197, 500.00, 130.00, 270.00, '1', 1, 100.00, NULL, '0'),
(495, 'Super D tempered Glass ', NULL, 99, 800.00, 150.00, 550.00, '1', 1, 100.00, NULL, '0'),
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `purchase`
--
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `repair_categories`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `repair_categories`
--
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `repair_items`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `repair_items`
--
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `repair_sell_records`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `repair_sell_records`
--
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `repair_stock`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `repair_stock`
--

INSERT INTO `repair_stock` (`id`, `stock_item_name`, `stock_qty`, `stock_cost`, `created_at`) VALUES
(7, 'Clear Tmpered glass', 490, 150.00, '2024-10-03 04:35:53'),
...
(38, 'Samsung A10s normal Display', 3, 2400.00, '2024-10-06 11:41:09'),
...
(55, 'Y5 2018 Display', 2, 2500.00, '2024-10-07 05:35:40'),
...
(88, 'Redmi 9A Display Replacement', 3, 2600.00, '2024-10-08 11:36:19'),
...
(93, 'Vivo y65 Display Replacement', 1, 2500.00, '2024-10-08 12:54:39'),
...
--
-- වගුවක් සඳහා වගු සැකිල්ල `repair_stock_map`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `repair_stock_map`
--
...
--
-- වගු සඳහා නික්ෂේප දත්ත `transaction_log`
--
...
--
ALTER TABLE `action_log`
  MODIFY `action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=894;
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_number` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `oneTimeProducts_sales`
  MODIFY `oneTimeProduct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `salary`
  MODIFY `salary_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT for table `sales`
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `transaction_log`
  MODIFY `transaction_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
...
--
-- වගුව සඳහා සීමා බාධක `makeProduct`
--
ALTER TABLE `makeProduct`
...
--
-- වගුව සඳහා සීමා බාධක `oneTimeProducts_sales`
--
ALTER TABLE `oneTimeProducts_sales`
...
--
-- වගුව සඳහා සීමා බාධක `repair_items`
--
ALTER TABLE `repair_items`
...
--
-- වගුව සඳහා සීමා බාධක `repair_sell_records`
--
ALTER TABLE `repair_sell_records`
...
--
-- වගුව සඳහා සීමා බාධක `repair_stock_map`
--
ALTER TABLE `repair_stock_map`
